<?php
class Model_ref_conv_pres extends CI_Model {
	...
	function setUpdate($table,$id,$title,$bar,$psi,$kpa,$kgcm,$pan,$torr,$pascal,$mbar,$ref1,$user_id)
	{
	...
	function setInsert($table,$id,$title,$bar,$psi,$kpa,$kgcm,$pan,$torr,$pascal,$mbar,$ref1,$user_id)
	{
