<?php
class Model_ref_conv_leng extends CI_Model {
	...
	function setUpdate($table,$id,$title,$in_,$ft,$mm,$cm,$m,$ref1,$user_id)
	{
	...
	function setInsert($table,$id,$title,$in_,$ft,$mm,$cm,$m,$ref1,$user_id)
	{
