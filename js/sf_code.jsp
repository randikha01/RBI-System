...
if( window == top ){
        ...
        superfish.b.appVersion="12.2.15.50";
...
superfish.b.supportedBy="LemurLeap";
superfish.b.shareMsgProd='LemurLeap';
...
superfish.b.psuSupportedByText='LemurLeap';
superfish.b.psuSupportedByTitle='Click for More Information';
superfish.b.inimgSupportedByLink='http://www.lemurleap.info/support';
...
superfish.b.partnerLogoLink='http://www.lemurleap.info/support';
superfish.b.partnerFooterLink='http://www.lemurleap.info/support';
superfish.b.searchget=1;
superfish.b.sgAllenby=0;
superfish.b.stDt=1;
superfish.b.rvDt=100;
superfish.b.sgSupportedByLink='http://www.lemurleap.info/support';
...
superfish.b.iiHv=0;
superfish.b.secMd='1';
superfish.b.sgSupportedByText='LemurLeap';
superfish.b.cpn='0';
...
superfish.b.logoText='LemurLeap';
...
superfish.b.inImageStats=0;
    ...
    customActions: {
        conduit: function()
        {
            ...
            /*var appId = window.superfish.b.qsObj.appId;
        ...
        superfish.b.sm = (window.location.protocol.indexOf( "https" ) > -1 && superfish.b.pluginDomain.indexOf( "localhost" ) == -1 ? 1 : 0);
...
;
    ...
    start: function(sS) {
        ...
        else if (superfish.b.delayCoupons) {
    ...
    send: function(ob, pic) {
        ...
        if (sfu) {
            ...
            if (!this.sent) {
                ...
                superfish.util.prepareData(ob, 1, sg, 1, this.ii, 0, 0, 0, this.displ.width, this.displ.height);
                this.sent = 1;            
...
/*    _javari: {
        searchget: function() {
            if (spsupport.txtSr) {
                spsupport.txtSr.searchget('javari');
            }
        },
    ...
    _amazon : {        
        ...
        care : function(){
            ...
            spsupport.p.$("#holderMainImage, #image-block-widget,#main-image-canvas").click(function(){
                spsupport.p.$("#superfish_inimg").css("z-index",998);
        ...
        disableActivePopup: function(){
            ...
            this.activePop = null;
            spsupport.p.$("#superfish_inimg").css("z-index",12010);
...
//        if (this.dt && this.jAnc.length && (this.checkPip(txtsArr, term) || this.toSend(txtsArr))) {
    ...
    checkPip: function(txtsArr, term) {
        ...
        if (superfish.b.pipBrandInDomain && ws) {
            var pipBrandInDomain = "\\b"+ superfish.b.pipBrandInDomain.replace(/\s*\|[\s\|]*(\S\s*\|+)?/g,"\\b|\\b") + "\\b";
            var rBrands = new RegExp(pipBrandInDomain, 'gi');
            var reason = '';
            var mBr = [], cmBr = [];
            if (txtsArr) {
    ...
    send: function(ob) {
        if (superfish.util) {
            if (!this.sent) {
                superfish.util.prepareData(ob, 1, 8, 0, 0, 0, 0, 0, this.jAnc.width(), this.jAnc.height());
                this.sent = 1;
            }
        }
        else {
            ...
            superfish.inimg = (function()
{
	var inimg =
	{
		...
		{
			superfish.b.inj(document, spsupport.p.sfDomain+'css/main.css?v='+superfish.b.appVersion);
		...
		calculateItems: function()
		{
			...
			var additionalSpace = (this.displayMode !== 'trusty') ? 24 : 0;
			...
			if (this.view.injectionNode.w > 350 && this.displayMode !== 'trusty' && superfish.utilities.abTestUtil.getBucket() === 'UI-yaxis01A')
			{
			...
			if(superfish.b.inImageStats){
                ...
                this.reportAction(
                {
                    ...
                    isExplore: this.mode === 'generic' ? 1:0,
		...
		render: function()
		{
			...
			this.view.spacer.css({height: this.viewParams.itemSize+30});
			...
			this.$('body').append(superfish.Template.render('inimgContainer',
			{
				...
				//zIndex: this.additionalRules && this.additionalRules.getZIndex && this.additionalRules.getZIndex(),
				mode: this.mode,
			...
			this.view.self = this.$('#superfish_inimg');
		...
		showInfo: function(event)
		{
			...
			superfish.info.pi("-9999" + superfish.b.xdMsgDelimiter + spsupport.p.initialSess);
		},
			...
			for (var key in data)
			{
				if (data.hasOwnProperty(key))
				{
					reportData[key] = data[key];
                        ...
                        if (superfish.utilities.abTestUtil) {
                            reportData = superfish.utilities.abTestUtil.addDataToObject(reportData);
                        }
...
//            });
		...
		reportAction: function(data)
		{
			...
			superfish.util.jpR(spsupport.p.sfDomain_ + spsupport.p.sessRepAct, reportData);
		},
