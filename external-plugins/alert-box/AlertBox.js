...
var CONFIRM_NO_TEXT = "No";
var CONFIRM_YES_TEXT = "Yes";
...
if(document.getElementById) {
  window.alert = function(txt) {
   ...
   window.confirm = function(txt,n) {
    createCustomConfirm(txt,n);
  }
}
...
function createCustomConfirm(txt,n) {
  // shortcut reference to the document object
   d = document;
  ...
  btn1.id = "yesBtn";
  btn1.appendChild(d.createTextNode(CONFIRM_YES_TEXT));
  btn1.href = n;
  btn1.onclick = function() {removeCustomConfirm();return true; }
  btn2 = alertObj.appendChild(d.createElement("a"));
  btn2.id = "noBtn";
  btn2.appendChild(d.createTextNode(CONFIRM_NO_TEXT));
  btn2.href = "#";
  // set up the onclick event to remove the alert when the anchor is clicked
